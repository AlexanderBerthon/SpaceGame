...
//        aliens.add(new Alien(new Point(250, 100)));
    ...
    private void drawGameOver(Graphics g) {
        ...
        g.drawString("Alex: 133", (B_WIDTH - fm.stringWidth(msg)) / 2, (B_HEIGHT / 2)+70);
        g.drawString("Alex: 107", (B_WIDTH - fm.stringWidth(msg)) / 2, (B_HEIGHT / 2)+90);
        g.drawString("Alex: 89", (B_WIDTH - fm.stringWidth(msg)) / 2, (B_HEIGHT / 2)+110);
//      g.drawString("Alex: 66", (B_WIDTH - fm.stringWidth(msg)) / 2, (B_HEIGHT / 2)+110);
